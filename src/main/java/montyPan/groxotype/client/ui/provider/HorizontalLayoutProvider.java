...
public class HorizontalLayoutProvider extends ComponentProvider<HorizontalLayoutContainer> {
	interface MyUiBinder extends UiBinder<Widget, HorizontalLayoutProvider> {}
	...
	@Override
	protected HorizontalLayoutContainer genComponent() {
